...
def getCivChineseNameKey(iPlayer):
    PlayerCivNameHashMap = {
        iEgypt: 'TXT_KEY_CIV_EGYPT_DESC',
        iBabylonia: 'TXT_KEY_CIV_BABYLONIA_DESC',
        iHarappa: 'TXT_KEY_CIV_HARAPPA_DESC',
        iChina: 'TXT_KEY_CIV_CHINA_DESC',
        iGreece: 'TXT_KEY_CIV_GREECE_DESC',
        iIndia: 'TXT_KEY_CIV_INDIA_DESC',
        iCarthage: 'TXT_KEY_CIV_PHOENICIA_DESC',
        iPolynesia: 'TXT_KEY_CIV_POLYNESIA_DESC',
        iPersia: 'TXT_KEY_CIV_PERSIA_DESC',
        iRome: 'TXT_KEY_CIV_ROME_DESC',
        iMaya: 'TXT_KEY_CIV_MAYA_DESC',
        iTamils: 'TXT_KEY_CIV_TAMILS_DESC',
        iEthiopia: 'TXT_KEY_CIV_ETHIOPIA_DESC',
        iKorea: 'TXT_KEY_CIV_Korea_DESC',
        iByzantium: 'TXT_KEY_CIV_Byzantium_DESC',
        iJapan: 'TXT_KEY_CIV_Japan_DESC',
        iVikings: 'TXT_KEY_CIV_VIKING_DESC',
        iTurks: 'TXT_KEY_CIV_Turks_DESC',
        iArabia: 'TXT_KEY_CIV_Arabia_DESC',
        iTibet: 'TXT_KEY_CIV_Tibet_DESC',
        iIndonesia: 'TXT_KEY_CIV_Indonesia_DESC',
        iMoors: "TXT_KEY_CIV_Moors_DESC",
        iSpain: 'TXT_KEY_CIV_Spain_DESC',
        iFrance: 'TXT_KEY_CIV_France_DESC',
        iKhmer: 'TXT_KEY_CIV_Khmer_DESC',
        iEngland: 'TXT_KEY_CIV_England_DESC',
        iHolyRome: 'TXT_KEY_CIV_HOLY_ROMAN_DESC',
        iRussia: 'TXT_KEY_CIV_Russia_DESC',
        iMali: 'TXT_KEY_CIV_Mali_DESC',
        iPoland: 'TXT_KEY_CIV_Poland_DESC',
        iPortugal: 'TXT_KEY_CIV_Portugal_DESC',
        iInca: 'TXT_KEY_CIV_Inca_DESC',
        iItaly: 'TXT_KEY_CIV_Italy_DESC',
        iMongolia: 'TXT_KEY_CIV_MONGOL_DESC',
        iAztecs: 'TXT_KEY_CIV_Aztecs_DESC',
        iMughals: 'TXT_KEY_CIV_Mughals_DESC',
        iOttomans: 'TXT_KEY_CIV_Ottoman_DESC',
        iThailand: 'TXT_KEY_CIV_Thailand_DESC',
        iCongo: 'TXT_KEY_CIV_Congo_DESC',
        iNetherlands: 'TXT_KEY_CIV_Netherlands_DESC',
        iGermany: 'TXT_KEY_CIV_Germany_DESC',
        iAmerica: 'TXT_KEY_CIV_America_DESC',
        iArgentina: 'TXT_KEY_CIV_Argentina_DESC',
        iBrazil: 'TXT_KEY_CIV_Brazil_DESC',
        iCanada: 'TXT_KEY_CIV_Canada_DESC'
    }

    iPlayerRebornHashMap={
        iAztecs:'TXT_KEY_CIV_MEXICO_DESC',
        iMaya:'TXT_KEY_CIV_COLOMBIA_DESC',
        iPersia:'TXT_KEY_CIV_IRAN_DESC'
    }
    keytxt=PlayerCivNameHashMap.get(iPlayer)
    keytxt=keytxt.upper()
...
def CivNameSuffx(iPlayer):
    ...
    if CollapseTurn >= 0:
        txt += u'[正在崩溃][' + str(CollapseTurn) + u']'

    return txt

def desc(iPlayer, sTextKey=str("%s1")):
    if(gc.getDefineINT("PYTHON_DISABLE_DYNAMIC_NAMES") > 0):
        ...
        #txt = text(sTextKey, (short(iPlayer), gc.getPlayer(iPlayer).getCivilizationAdjective(0)))
        key="TXT_KEY_CIV_" + short(iPlayer).replace(" ", "_").upper()+'_DESC'
        txt=utils.getText(getCivChineseNameKey(iPlayer))
        txt+=CivNameSuffx(iPlayer)
...
def leader(iPlayer):
    ...
    if iPlayer == iEgypt:
        ...
        if isCommunist(iPlayer) or isRepublic(iPlayer) and iEra >= iIndustrial:
            if (gc.getDefineINT('PYTHON_LEADER_DISABLE_MAO') > 0):
                return iHongwu
            else:
                return iMao
