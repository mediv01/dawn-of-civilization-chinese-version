...
tMinorCities = (
    ...
    (-1900, (103, 47), iIndependent, 'ZhongDu', 2, iArcher, 1),  # Beijing
    (-1900, (106, 45), iIndependent, 'DongYi', 2, iArcher, 1),  # DongYi
    (-1900, (107, 42), iIndependent, 'GuSu', 2, iMilitia, 1),  # GuSu
    (-1900, (104, 42), iIndependent, 'Miao', 2, iMilitia, 1),  # Miao
    (-1700, (68, 45), iIndependent, 'Constantinople', 1, iHoplite, 1),  # Constantinople
    (-1600, (90, 40), iIndependent, 'Indraprastha', 1, iMilitia, 1),  # Delhi
    (-1000, (104, 39), iIndependent, 'BaiYue', 2, iArcher, 1),  # BaiYue
    (-1000, (72, 44), iIndependent, 'Ankuwash', 2, iArcher, 2),  # Ankara
    (-760, (59, 47), iCeltia, 'Melpum', 2, iArcher, 2),  # Milan
    (-750, (107, 48), iIndependent, 'Simiyan hoton', 2, iArcher, 1),  # Shenyang
    (-350, (56, 47), iCeltia, 'Lugodunon', 2, iMilitia, 1),  # Lyon
    (-325, (92, 33), iIndependent, 'Kanchipuram', 2, iArcher, 1),  # Madras
    (-300, (53, 48), iCeltia, 'Burdigala', 2, iMilitia, 1),  # Bordeaux
    (-300, (91, 31), iIndependent, 'Tanjapuri', 1, iWarElephant, 1),  # Thanjavur
    (-250, (19, 35), iNative, 'Danibaan', 2, iHolkan, 1),  # Monte Alb�n
    (-190, (77, 44), iIndependent2, 'Artashat', 1, iMilitia, 1),  # Artaxata
    ...
    (866, (101, 37), iBarbarian, 'Hanoi', 2, iMilitia, 1),  # Hanoi
    ...
    (990, (49, 56), iCeltia, '&#193;th Cliath', 1, iMilitia, 1),  # Dublin
...
tMinorCities_1 = (
    ...
    #(-1000, (102, 47), iIndependent, 'Zhongdu', 2, iSpearman, 1),	# Beijing
    (-1900, (103, 47), iIndependent, 'ZhongDu', 2, iArcher, 1),  # Beijing
    (-1900, (106, 45), iIndependent, 'DongYi', 2, iArcher, 1),  # Beijing
    (-1900, (107, 42), iIndependent, 'GuSu', 2, iArcher, 1),  # Beijing
    (-1900, (104, 42), iIndependent, 'MiaoRen', 2, iArcher, 1),  # Beijing
    (-1700, (68, 45), iIndependent, 'Constantinople', 1, iHoplite, 1),  # Constantinople
    (-1600, (90, 40), iIndependent, 'Indraprastha', 1, iMilitia, 1),  # Delhi
    (-1000, (104, 39), iIndependent, 'BaiYue', 2, iArcher, 1),  # Beijing
    (-1000, (72, 44), iIndependent, 'Ankuwash', 2, iArcher, 2),  # Ankara
    (-760, (59, 47), iCeltia, 'Melpum', 2, iArcher, 2),  # Milan
    (-750, (107, 48), iBarbarian, 'Simiyan hoton', 2, iArcher, 1),  # Shenyang
    (-350, (56, 47), iCeltia, 'Lugodunon', 2, iMilitia, 1),  # Lyon
    (-325, (92, 33), iIndependent, 'Kanchipuram', 2, iArcher, 1),  # Madras
    (-300, (53, 48), iCeltia, 'Burdigala', 2, iMilitia, 1),  # Bordeaux
    (-300, (91, 31), iIndependent, 'Tanjapuri', 1, iWarElephant, 1),  # Thanjavur
...
tMinorCities_2 = (
    ...
    #(-2000, (92, 39), iIndependent, 'Varanasi', 1, iMilitia, 1), 	# Varanasi
    #(-1000, (102, 47), iIndependent, 'Zhongdu', 2, iSpearman, 1),	# Beijing
    (-1900, (103, 47), iIndependent, 'ZhongDu', 2, iArcher, 2),  # Beijing
    (-1900, (106, 45), iIndependent, 'DongYi', 2, iArcher, 2),  # Beijing
    (-1900, (107, 42), iIndependent, 'GuSu', 2, iArcher, 2),  # Beijing
    (-1900, (104, 42), iIndependent, 'MiaoRen', 2, iArcher, 2),  # Beijing
    (-1700, (68, 45), iIndependent, 'Constantinople', 1, iHoplite, 1),  # Constantinople
    (-1600, (90, 40), iIndependent, 'Indraprastha', 1, iMilitia, 1),  # Delhi
    (-1000, (104, 39), iIndependent, 'BaiYue', 2, iArcher, 2),  # Beijing
    (-1000, (72, 44), iIndependent, 'Ankuwash', 2, iArcher, 2),  # Ankara
    (-760, (59, 47), iCeltia, 'Melpum', 2, iArcher, 2),  # Milan
    (-750, (107, 48), iBarbarian, 'Simiyan hoton', 2, iArcher, 2),  # Shenyang
    (-350, (56, 47), iCeltia, 'Lugodunon', 2, iMilitia, 1),  # Lyon
    (-325, (92, 33), iIndependent, 'Kanchipuram', 2, iArcher, 1),  # Madras
    (-300, (53, 48), iCeltia, 'Burdigala', 2, iMilitia, 1),  # Bordeaux
    (-300, (91, 31), iIndependent, 'Tanjapuri', 1, iWarElephant, 1),  # Thanjavur
...
tMinorCities_3 = (
    ...
    #(-2000, (92, 39), iIndependent, 'Varanasi', 1, iMilitia, 1), 	# Varanasi
    #(-1000, (102, 47), iIndependent, 'Zhongdu', 2, iSpearman, 1),	# Beijing
    (-1900, (103, 47), iIndependent, 'ZhongDu', 2, iArcher, 1 + 2),  # Beijing
    (-1900, (106, 45), iIndependent, 'DongYi', 2, iArcher, 1 + 2),  # Beijing
    (-1900, (107, 42), iIndependent, 'GuSu', 2, iArcher, 1 + 2),  # Beijing
    (-1900, (104, 42), iIndependent, 'MiaoRen', 2, iArcher, 1 + 2),  # Beijing
    (-1700, (68, 45), iIndependent, 'Constantinople', 1, iHoplite, 1),  # Constantinople
    (-1600, (90, 40), iIndependent, 'Indraprastha', 1, iMilitia, 1),  # Delhi
    (-1000, (104, 39), iIndependent, 'BaiYue', 2, iArcher, 1 + 2),  # Beijing
    (-1000, (72, 44), iIndependent, 'Ankuwash', 2, iArcher, 2),  # Ankara
    (-760, (59, 47), iCeltia, 'Melpum', 2, iArcher, 2),  # Milan
    (-750, (107, 48), iBarbarian, 'Simiyan hoton', 2, iArcher, 1 + 2),  # Shenyang
    (-350, (56, 47), iCeltia, 'Lugodunon', 2, iMilitia, 1),  # Lyon
    (-325, (92, 33), iIndependent, 'Kanchipuram', 2, iArcher, 1),  # Madras
    (-300, (53, 48), iCeltia, 'Burdigala', 2, iMilitia, 1),  # Bordeaux
    (-300, (91, 31), iIndependent, 'Tanjapuri', 1, iWarElephant, 1),  # Thanjavur
...
tMinorCities_4 = (
    ...
    #(-2000, (92, 39), iIndependent, 'Varanasi', 1, iMilitia, 1), 	# Varanasi
    #(-1000, (102, 47), iIndependent, 'Zhongdu', 2, iSpearman, 1),	# Beijing
    (-1900, (103, 47), iIndependent, 'ZhongDu', 2, iArcher, 1 + 2 + 1),  # Beijing
    (-1900, (106, 45), iIndependent, 'DongYi', 2, iArcher, 1 + 2 + 1),  # Beijing
    (-1900, (107, 42), iIndependent, 'GuSu', 2, iArcher, 1 + 2 + 1),  # Beijing
    (-1900, (104, 42), iIndependent, 'MiaoRen', 2, iArcher, 1 + 2 + 1),  # Beijing
    (-1700, (68, 45), iIndependent, 'Constantinople', 1, iHoplite, 1),  # Constantinople
    (-1600, (90, 40), iIndependent, 'Indraprastha', 1, iMilitia, 1),  # Delhi
    (-1000, (104, 39), iIndependent, 'BaiYue', 2, iArcher, 1 + 2 + 1),  # Beijing
    (-1000, (72, 44), iIndependent, 'Ankuwash', 2, iArcher, 2),  # Ankara
    (-760, (59, 47), iCeltia, 'Melpum', 2, iArcher, 2),  # Milan
    (-750, (107, 48), iBarbarian, 'Simiyan hoton', 2, iArcher, 1 + 2 + 1),  # Shenyang
    (-350, (56, 47), iCeltia, 'Lugodunon', 2, iMilitia, 1),  # Lyon
    (-325, (92, 33), iIndependent, 'Kanchipuram', 2, iArcher, 1),  # Madras
    (-300, (53, 48), iCeltia, 'Burdigala', 2, iMilitia, 1),  # Bordeaux
    (-300, (91, 31), iIndependent, 'Tanjapuri', 1, iWarElephant, 1),  # Thanjavur
...
#if iHandicap1==0:
#	tMinorCities=tMinorCities_0
#elif iHandicap1==1:
#	tMinorCities=tMinorCities_0
#elif iHandicap1==2:
#	tMinorCities=tMinorCities_1
#elif iHandicap1==3:
#	tMinorCities=tMinorCities_2
#elif iHandicap1==4:
#	tMinorCities=tMinorCities_2
    ...
    def foundMinorCities(self, iGameTurn):
        for i in range(len(tMinorCities)):
            ...
            if iHandicap1 == 0:  #根据难度区分的独立城邦
                tMinorCities_actual = tMinorCities
            elif iHandicap1 == 1:
                tMinorCities_actual = tMinorCities_1
            elif iHandicap1 == 2:
                tMinorCities_actual = tMinorCities_2
            elif iHandicap1 == 3:
                tMinorCities_actual = tMinorCities_3
            elif iHandicap1 == 4:
                tMinorCities_actual = tMinorCities_4
#			iYear, tPlot, iPlayer, sName, iPopulation, iUnitType, iNumUnits = tMinorCities[i]
            iYear, tPlot, iPlayer, sName, iPopulation, iUnitType, iNumUnits = tMinorCities_actual[i]
...
##		#checks if there's a unit on the plot
    ...
    def checkSpawn(self, iPlayer, iUnitType, iNumUnits, tTL, tBR, spawnFunction, iTurn, iPeriod, iRest, lAdj=[]):
        ...
        if iTurn % utils.getTurns(iPeriod) == iRest - 3:
            if (len(sAdj) > 0 and gc.getDefineINT("PYTHON_SHOW_BARBARIAN_TEXT") == 1):
                #a= localText.getText(sAdj, ())
                name = lAdj[0]
                civname = name
                #a=CyTranslator().getText(str(name ), (name ,))
