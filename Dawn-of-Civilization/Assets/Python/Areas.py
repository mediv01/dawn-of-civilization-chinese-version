...
def getBirthRectangle(iPlayer, bExtended=None):
    ...
    if (gc.getGame().getActivePlayer() == iPlayer and gc.getDefineINT('PYTHON_ADJUST_FLIPZONE_FOR_HUMAN')==1):
        if (iPlayer == iArgentina):
            iArea=tBirthArea[iPlayer]
            if (iHandicap == 0):
                iArea = ((29, 7), (41, 16))
            elif(iHandicap == 1):
                iArea = ((31, 7), (41, 16))
...
dCoreAreaExceptions = {
    ...
    iAmerica: [(23, 50), (27, 50), (29, 50), (30, 50), (12, 44), (13, 44), (13, 43), (14, 44), (15, 44), (15, 43), (16, 44), (16, 43), (17, 44), (17, 43)],
    iArgentina: [(35, 12)],
